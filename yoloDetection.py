...
def detectObject(CNNnet, total_layer_names, image_height, image_width, image, name_colors, class_labels,  
    ...
    if detect:
        ...
        Boundingboxes, confidence_value, class_ids,totcount = listBoundingBoxes(cnn_outs_layer, image_height, image_width, 0.5)
        ...
        image,countone = labelsBoundingBoxes(image, Boundingboxes, confidence_value, class_ids, ids, name_colors, class_labels)
        accuracy = countone/totcount
    return image, Boundingboxes, confidence_value, class_ids, ids,accuracy,countone,totcount
...
def listBoundingBoxes(image, image_height, image_width, threshold_conf):
    ...
    return box_array, confidence_array, class_ids_array,totcount
